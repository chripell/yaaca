...
libyaaca.so.1: yaaca_server.c yaaca_server.h sb.o
	...
	g++ -ggdb -pthread -shared -Wl,-soname,libyaaca.so.1 -o libyaaca.so.1.0.1 \
		yaaca_server.o jsmn.o sb.o ${ASILIB_${ARCH}} ./libusb-1.0.20/libusb/.libs/libusb-1.0.a -ludev -lc
...
sb.o: sb.c
	gcc -ggdb -pthread -DSELF_BULK -D_GNU_SOURCE -fPIC -std=c99 -Ilibusb-1.0.20/libusb -g -c -Wall sb.c
